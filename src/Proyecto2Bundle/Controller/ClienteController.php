...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clientes = $em->getRepository('Proyecto2Bundle:Cliente')->findAll();
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('Proyecto2Bundle\Form\ClienteType', $cliente);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('Proyecto2Bundle\Form\ClienteType', $cliente);
